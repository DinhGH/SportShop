    ...
    <head runat="server">
        ...
        <style>
            ...
            .btn-auth {
                ...
                border-radius: 6px;
                color: #ffffff;
                /* Chữ trắng nổi bật trên nút xám */
                font-size: 16px;
                font-weight: bold;
                cursor: pointer;
    ...
    <body>
        <form id="form1" runat="server">
            <div class="auth-container">
                ...
                <asp:Button ID="btnLogin" runat="server" Text="Đăng Nhập" CssClass="btn-auth"
                    OnClick="btnLogin_Click" />

                <div class="auth-footer">
                    Chưa có tài khoản?
                    <!-- Nút chuyển đổi sang trang đăng ký -->
                    <asp:HyperLink ID="lnkRegister" runat="server" NavigateUrl="~/Register.aspx" CssClass="auth-link">
                        Đăng ký ngay</asp:HyperLink>
                </div>
            </div>
        </form>
    </body>
