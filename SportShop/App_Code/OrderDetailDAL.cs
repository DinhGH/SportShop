...
namespace SportShop.App_Code
{
    public class OrderDetailDAL
    {
        ...
        {
            string query = $"SELECT od.*, p.ProductName, o.CreatedAt FROM OrderDetails od " +
        ...
        {
            string query = $"UPDATE OrderDetails SET Status = N'{status}' WHERE OrderDetailID = {orderDetailId}";
